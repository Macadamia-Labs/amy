...
const ResultGroup = ({ title, results, displayCount }: ResultGroupProps) => {
  ...
  const displayResults = displayCount ? results.slice(0, displayCount) : results
      ...
      <div className="px-4 py-4 border-b border-gray-200 bg-white">
        <div className="relative">
          <Input
            ...
            className="w-full px-4 py-2 bg-muted border-none rounded-lg focus:outline-none focus:ring-0"
          />
        </div>
      </div>
