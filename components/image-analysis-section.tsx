...
import { ImageAnalysisResponse } from '../lib/tools/image-analysis'
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="text-xs font-medium text-muted-foreground">Image URL</h4>
                  <p className="text-sm break-all">{imageUrl}</p>
                </div>
                <div>
                  <h4 className="text-xs font-medium text-muted-foreground">Question</h4>
